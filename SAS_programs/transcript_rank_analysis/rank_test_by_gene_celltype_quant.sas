...
data cc.xscript_rank_test_m37_anova_v3;
set xs_rank_glm_m37;
run;

data cc.xscript_rank_test_m37_resid_v3;
set exon_rank_resid_m37;
run;

data cc.xscript_rank_test_m37_pdiffs;
set pdiff_m37;
run;

data cc.xscript_rank_test_m37_anova_v3b;
set xs_rank_glm_m37;
run;

data cc.xscript_rank_test_m37_resid_v3b;
set exon_rank_resid_m37;
run;

data cc.xscript_rank_test_m37_slices;
set slice_m37;
run;


/* Calculate FDR for quantitative rank test (1->N) */


data ranktest;
  set cc.xscript_rank_test_m37_anova_v3;
...
data cc.m37_anova_fdr_ranktest_1_N;
