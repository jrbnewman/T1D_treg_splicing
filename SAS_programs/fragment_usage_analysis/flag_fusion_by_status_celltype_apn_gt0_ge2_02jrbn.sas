...
data frag_counts_tall;
  set cclocal.fusion_counts_by_sample;
run;
...
data cc.flag_fusion_apn_gt0_ge2_127;
   set flag_frag_by_trt_127;
run;

data cc.flag_fusion_apn_gt0_ge2_400;
   set flag_frag_by_trt_400;
run;

data cc.flag_fusion_apn_gt0_ge2_425;
   set flag_frag_by_trt_425;
run;

data cc.flag_fusion_apn_gt0_ge2_426;
